...
use Pidev\ReaBundle\Form\AgenceType;
...
class AgenceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PidevReaBundle:Agence')->findAll();

        return $this->render('PidevReaBundle:Agence:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PidevReaBundle:Agence:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PidevReaBundle:Agence')->find($id);
        ...
        return $this->render('PidevReaBundle:Agence:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PidevReaBundle:Agence:edit.html.twig', array(
            'entity'      => $entity,
