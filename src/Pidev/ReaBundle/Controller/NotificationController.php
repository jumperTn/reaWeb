...
use Pidev\ReaBundle\Entity\Notification;
use Pidev\ReaBundle\Form\NotificationType;
...
class NotificationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PidevReaBundle:Notification')->findAll();

        return $this->render('PidevReaBundle:Notification:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PidevReaBundle:Notification:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('PidevReaBundle:Notification:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PidevReaBundle:Notification:edit.html.twig', array(
            'entity'      => $entity,
