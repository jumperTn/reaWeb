 ...
 */
class Immeuble extends \Pidev\ReaBundle\Entity\Immeuble implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Immeuble' . "\0" . 'nbretage', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Immeuble' . "\0" . 'nbrappartement', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Immeuble' . "\0" . 'idoffre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Immeuble $proxy) {
