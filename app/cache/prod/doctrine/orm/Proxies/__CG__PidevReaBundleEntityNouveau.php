 ...
 */
class Nouveau extends \Pidev\ReaBundle\Entity\Nouveau implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Nouveau' . "\0" . 'idoffre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Nouveau $proxy) {
