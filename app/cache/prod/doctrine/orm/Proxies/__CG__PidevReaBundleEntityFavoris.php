 ...
 */
class Favoris extends \Pidev\ReaBundle\Entity\Favoris implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Favoris' . "\0" . 'id', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Favoris' . "\0" . 'idutilisateur', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Favoris' . "\0" . 'idoffre');
        }
