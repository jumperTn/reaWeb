 ...
 */
class Ban extends \Pidev\ReaBundle\Entity\Ban implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Ban' . "\0" . 'id', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Ban' . "\0" . 'idagence', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Ban' . "\0" . 'idutilisateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ban $proxy) {
    ...
    public function setIdagence(\Pidev\ReaBundle\Entity\Agence $idagence = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdagence', array($idagence));
    ...
    public function getIdagence()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdagence', array());
