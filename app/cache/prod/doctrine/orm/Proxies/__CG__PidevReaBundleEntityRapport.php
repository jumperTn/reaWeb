 ...
 */
class Rapport extends \Pidev\ReaBundle\Entity\Rapport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Rapport' . "\0" . 'id', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Rapport' . "\0" . 'datecreation', '' . "\0" . 'Pidev\\ReaBundle\\Entity\\Rapport' . "\0" . 'datemodification');
        }
